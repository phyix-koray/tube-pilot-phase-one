...
/**
 * Agent Team canvas'ının tamamı. Bilerek route dosyasından ayrıldı ve
 * lazy + client-only olarak yükleniyor — @xyflow/react tarayıcı API'lerine
 * (ResizeObserver, window, document) bağımlı olduğu için SSR sırasında
 * import edilirse sessizce hydration/render sorununa yol açıyordu.
 */
export default function AgentTeamCanvas({ teamId }: { teamId: string }) {
